mod answers_tests {
    ...
    async fn create_answer_should_fail_if_database_error_occurs(
        ...
        let result = answer_doa
            .create_answer(Answer {
                question_uuid: Uuid::parse_str("a22abcd2-22ab-2222-a22b-2abc2a2b22cc").unwrap(),
    ...
    async fn delete_answer_should_fail_if_database_error_occurs(
        ...
        let result = answer_doa
            .delete_answer(Uuid::parse_str("a22abcd2-22ab-2222-a22b-2abc2a2b22cc").unwrap())
            .await;
    ...
    async fn get_answers_should_fail_if_database_error_occurs(pool: PgPool) -> Result<(), String> {
        ...
        let result = answer_doa
            .get_answers(Uuid::parse_str("a22abcd2-22ab-2222-a22b-2abc2a2b22cc").unwrap())
            .await;
...
mod questions_tests {
    ...
    async fn delete_question_should_fail_if_database_error_occurs(
        ...
        let result = doa
            .delete_question(Uuid::parse_str("a22abcd2-22ab-2222-a22b-2abc2a2b22cc").unwrap())
            .await;
